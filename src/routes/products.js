...
router.post('/product/:userId', checkToken, requiredSignin, isAuth, isAdmin, uploadServer.single('image'), addProduct);
router.put('/product/:id/:userId', checkToken, requiredSignin, isAuth, isAdmin, uploadServer.single('image'), editProduct);
